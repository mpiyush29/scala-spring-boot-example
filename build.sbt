...
lazy val root = project
  .in(file("."))
  .settings(
    name := "scala-spring-boot-example",
    version := "1.0.0-SNAPSHOT",
    scalaVersion := "3.1.2",
    assembly / mainClass := Some("com.github.mpiyush29.scalaspringbootexample.ExampleApp"),
    assembly / assemblyJarName := "scala-spring-boot-example.jar",
